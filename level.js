...
var levels = [
  {
    ...
    gen: function () {
      var plane1 = new Plane(new Player(100, 100, "Assets/Player1.png", ["%", "'", "&", "(", "¾"]), [new Default(50, 500, 400, 200, "green", new Vector(1, 0)), new PhasedIn(450, 520, 240, 100, "green", new Vector(1, 0), 0), new PlaneSwitch(80, 500), new Desk(300, 500), new Shelf(240, 500)], new Vector(0, 0.7), "Assets/plane1Background.png");
      var plane2 = new Plane(new Player(100, 100, "Assets/Player2.png", ["%", "'", "&", "(", "¾"]), [new Default(50, 200, 400, 100, "green", new Vector(1, 0)), new Default(460, 500, 300, 50, "green", new Vector(1, 0)), new PlaneSwitch(80, 200), new PlaneSwitch(560, 500), new Platform(470, 400, 100, 5, "Assets/platform.png", new Vector(1, 0)), new PhaseLever(700, 500, 0)], new Vector(0, .3), "Assets/plane2Background.png");
